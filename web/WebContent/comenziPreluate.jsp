		...
		<div class="profil_privat" align="center">
			...
			<table>
				...
				<tr>
					...
					<td><input type="password" name="current_psw" id="current_psw">
				</tr>
				<tr>
					<td></td>
				</tr>
				...
				<tr>
					...
					<td><input type="password" name="confirm_new_psw" id="confirm_new_psw">
				</tr>
				<tr>
					<td></td>
				</tr>
			...
			<input class="btn" type="submit" value="Editare">
			</div>
			</form>
		</div>
	</div>