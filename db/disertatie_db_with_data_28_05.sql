...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2016 at 01:19 PM
...
(2, 'Popa', 'Gigel', '2222', 'operator', 2, 2),
(3, 'Ionescu', 'Alin', '3333', 'curier', 3, 3),
(4, 'Chirvase', 'George', '4444', 'curier', 4, 1),
(5, 'Ionescu', 'Bogdan', '5555', 'curier', 5, 3),
(6, 'Popa', 'Horia', '12345', 'operator', 6, 1),
(7, 'Popa', 'Claudiu', '7564', 'curier', 7, 2),
(8, 'Popescu', 'Razvan', '9847', 'operator', 8, 3);
...
--
-- AUTO_INCREMENT for table `operare`
--
ALTER TABLE `operare`
  MODIFY `operare_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `userlog`
--
ALTER TABLE `userlog`
  MODIFY `userlog_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
